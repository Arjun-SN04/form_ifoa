...
export const defaultFormSchema = {
  sections: [
    ...
    },
    {
      ...
      order: 2,
      fields: [
        { id: 'name', label: 'Registered Company Name', type: 'text', required: true, order: 0 },
        { id: 'telephone', label: 'Company Telephone', type: 'tel', required: true, order: 1 },
        { id: 'email', label: 'Business Contact Email', type: 'email', required: true, order: 2 },
        { id: 'street', label: 'Street & Number', type: 'text', required: true, order: 3 },
        { id: 'zipCode', label: 'Zip / Postal Code', type: 'text', required: true, order: 4 },
        { id: 'stateProvince', label: 'State / Province / Region', type: 'text', required: true, order: 5 },
        { id: 'country', label: 'Country', type: 'text', required: true, order: 6 },
        {
          id: 'operationTypes',
